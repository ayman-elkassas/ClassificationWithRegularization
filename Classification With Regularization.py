...
# from data distribution decision boundary is circle boundary
...
# adding in last col because x1,x2 are dropped in next steps
data.insert(3, 'Ones', 1)   # adding x0

print('data \n' , data.head(10))
print('................................................')

# Regularization for minimize overfitting effect

# 1-First step in Regularization -> change coefficients
'''
...
def costReg(theta,X,y,lr):
    ...
    # the same cost function from previous example but adding reg value as following
    # 2-Second step in Regularization -> (multiply lambda) in sum of theta expect theta0
